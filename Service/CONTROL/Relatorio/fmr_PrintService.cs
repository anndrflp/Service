...
namespace Service.CONTROL.Relatorio
{
    public partial class fmr_PrintService : Form
    {
        ...
        {
            // TODO: esta linha de código carrega dados na tabela 'paypeYan.DataTable2'. Você pode movê-la ou removê-la conforme necessário.
            this.dataTable2TableAdapter.Fill(this.paypeYan.DataTable2);
